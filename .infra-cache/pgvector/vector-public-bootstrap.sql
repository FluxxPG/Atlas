...
CREATE FUNCTION vector_in(cstring, oid, integer) RETURNS vector
	AS 'C:/Users/Public/pgvector/vector.dll' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;
...
CREATE FUNCTION ivfflathandler(internal) RETURNS index_am_handler
	AS 'C:/Users/Public/pgvector/vector.dll' LANGUAGE C;
...
CREATE FUNCTION l2_distance(halfvec, halfvec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'halfvec_l2_distance' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION inner_product(halfvec, halfvec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'halfvec_inner_product' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION cosine_distance(halfvec, halfvec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'halfvec_cosine_distance' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION l1_distance(halfvec, halfvec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'halfvec_l1_distance' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION vector_dims(halfvec) RETURNS integer
	AS 'C:/Users/Public/pgvector/vector.dll', 'halfvec_vector_dims' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION l2_norm(halfvec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'halfvec_l2_norm' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION l2_normalize(halfvec) RETURNS halfvec
	AS 'C:/Users/Public/pgvector/vector.dll', 'halfvec_l2_normalize' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION binary_quantize(halfvec) RETURNS bit
	AS 'C:/Users/Public/pgvector/vector.dll', 'halfvec_binary_quantize' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION subvector(halfvec, int, int) RETURNS halfvec
	AS 'C:/Users/Public/pgvector/vector.dll', 'halfvec_subvector' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;
...
CREATE FUNCTION halfvec_combine(double precision[], double precision[]) RETURNS double precision[]
	AS 'C:/Users/Public/pgvector/vector.dll', 'vector_combine' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;
...
CREATE FUNCTION l2_distance(sparsevec, sparsevec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'sparsevec_l2_distance' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION inner_product(sparsevec, sparsevec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'sparsevec_inner_product' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION cosine_distance(sparsevec, sparsevec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'sparsevec_cosine_distance' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION l1_distance(sparsevec, sparsevec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'sparsevec_l1_distance' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION l2_norm(sparsevec) RETURNS float8
	AS 'C:/Users/Public/pgvector/vector.dll', 'sparsevec_l2_norm' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE FUNCTION l2_normalize(sparsevec) RETURNS sparsevec
	AS 'C:/Users/Public/pgvector/vector.dll', 'sparsevec_l2_normalize' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;
